...
//Carrega mais pokemons ao clicar no botão de Carregar
...
function buildModal(pokemon) {
    ...
    <div class="header">
        ...
        <div class="logo">
        <img class="pokedex" src="assets/img/pokedex.png" alt="Pokedex logo">
        </div>
        </div>
        <div class="infos">
            <div class="detail">
...
function details(param, pokemonId){
    ...
    if(param == 'menu1'){
        ...
        <div class="about1">
            <div><label class="text-gray">Base. Exp.: </label> <label class="infosAbout">${pokemon.baseExp} exp.</label></div>
            <div><label class="text-gray">Height: </label> 
            <label class="infosAbout">${pokemon.height}</label></div>
            <div><label class="text-gray">Weight: </label>
            <label class="infosAbout">${pokemon.weight}</label></div>
            <div><label class="text-gray">Abilities: </label> <label class="infosAbout">${pokemon.abilities}</label></div>
            <div><label class="text-gray">Egg Groups: </label> <label class="infosAbout">${pokemon.eggGroups}</label></div>
            <div><label class="text-gray">Generation: </label> <label class="infosAbout">${pokemon.generation}</label></div>
        </div>
